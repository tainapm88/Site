          ...
          <div class="col-md-12 text-center">
            ...
            <div class="mb-5 element-animate">
              ...
              <li class="nav-item dropdown">
                <a href="booknow.html" class="btn btn-primary nav-link dropdown-toggle" href="rooms.html" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Medicamentos</a>
                <div class="btn btn-primary dropdown-menu" aria-labelledby="dropdown04">
                  <a class="dropdown-item" href="medicamentos.jsp">OPÇÃO 1</a>
                  <a class="dropdown-item" href="rooms.html">OPÇÃO 2</a>
                  <a class="dropdown-item" href="rooms.html">OPÇÃO 3</a>
